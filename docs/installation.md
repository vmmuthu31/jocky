...
```bash
curl -fsSL [https://raw.githubusercontent.com/vmmuthu31/jocky/main/install.sh](https://raw.githubusercontent.com/vmmuthu31/jocky/main/install.sh) | sh
...
```powershell
irm [https://raw.githubusercontent.com/vmmuthu31/jocky/main/install.ps1](https://raw.githubusercontent.com/vmmuthu31/jocky/main/install.ps1) | iex
...
```bash
git clone [https://github.com/vmmuthu31/jocky.git](https://github.com/vmmuthu31/jocky.git)
cd jocky
...
The JOCKY server provides the web dashboard and REST API.
...
See [Server Configuration](https://www.google.com/search?q=./server-config.md) for production setup with mTLS.
...
{% hint style="warning" %}
**Security Note:** Never use `JOCKY_ALLOW_DEV_KEY=1` in a production environment.
{% endhint %}